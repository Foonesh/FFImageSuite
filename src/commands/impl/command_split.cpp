...
void command_split::execute(char** arguments)
{
  ...
  *(unsigned int*)&contents[0x16] /= 2;
  ...
  std::ofstream filesOut[4] = { std::ofstream(arguments[1], std::ios::binary),
                                std::ofstream(arguments[2], std::ios::binary),
                                std::ofstream(arguments[3], std::ios::binary),
                                std::ofstream(arguments[4], std::ios::binary)
                              };
